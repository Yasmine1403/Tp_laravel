...
<div calss="form-group">
    ...
    Commentaire: {!! $errors->first('message', '<small class="help-block">:message</small>') !!}
    <textarea class="form-control @error('message') is-invalid @enderror" name = "commentaire" placeholder ="Tapez votre commentaire" ></textarea>
</div> 
